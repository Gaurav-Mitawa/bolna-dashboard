  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="w-full max-w-sm p-8 bg-white rounded-2xl shadow-xl">
        ...
        {errorMsg && (
          <div className="mb-4 bg-red-50 border border-red-200 rounded-lg p-3 text-sm text-red-700">
            {errorMsg === "db_unavailable"
              ? "⚠️ Database not connected. Make sure MongoDB is running and MONGODB_URI is set in .env"
              : errorMsg === "session_error"
                ? "⚠️ Session could not be saved. Check MongoDB connection."
        ...
        <Button
          className="w-full h-12 flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 hover:bg-gray-50"
          variant="outline"
