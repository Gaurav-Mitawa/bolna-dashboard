...
import { Loader2, Phone, BarChart3, Users } from "lucide-react";
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary/90 to-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <h1 className="text-4xl font-bold mb-4">
            Scale Your Voice Operations with AI
          </h1>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold">10,000+ Concurrent Calls</h3>
                <p className="text-white/70 text-sm">Scale without limits</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-white/20 flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm">Track every conversation</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-white/20 flex items-center justify-center">
              ...
              <div>
                <h3 className="font-semibold">Smart CRM Integration</h3>
                <p className="text-white/70 text-sm">Manage leads effortlessly</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            {errorMsg && (
              <div className="mb-6 bg-red-50 border border-red-200 rounded-xl p-4 text-sm text-red-700">
                {errorMsg === "db_unavailable"
                  ? "⚠️ Database not connected. Please try again later."
            ...
            <Button
              className="w-full h-14 flex items-center justify-center gap-3 bg-white border-2 border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-gray-300 rounded-xl transition-all duration-200 font-medium"
              variant="outline"
